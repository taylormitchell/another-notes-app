...
export type AllListsQuery = {
  ...
  allLists: Array<{
    ...
    id: number;
    name: string;
    notes: Array<{ __typename?: "Note"; id: number; text: string; author: string }>;
  }>;
};
...
export type AllNotesQuery = {
  __typename?: "Query";
  allNotes: Array<{ __typename?: "Note"; id: number; text: string; author: string }>;
};
...
export function useAllListsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<AllListsQuery, AllListsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useAllNotesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<AllNotesQuery, AllNotesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
...
export function useGetListLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetListQuery, GetListQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
