...
export type GetListQuery = { __typename?: 'Query', getList?: { __typename?: 'List', id: number, name: string, notes: Array<{ __typename?: 'Note', id: number, text: string, author: string, createdAt: string }> } | null };
